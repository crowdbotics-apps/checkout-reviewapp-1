...
## Project Structure
    ...
    ├── checkout_reviewapp_1  # Django project configurations
...
1. Clone this repo and `cd checkout_reviewapp_1`
...
2. Clone this repo and `cd checkout_reviewapp_1`
